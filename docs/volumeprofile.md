...
<!-- DOCS sử dụng chiến lược swing tradding -->

Chiến lược Swing Trading: SMC + Elliott Wave + Volume Profile

Mục tiêu

-   Elliott Wave: xác định bối cảnh và pha thị trường.
-   SMC: tìm điểm vào lệnh.
...
-   Chỉ ưu tiên giao dịch theo xu hướng.

2. Daily

-   Xác định sóng Elliott.
-   Tập trung tìm điểm mua ở cuối sóng 2 hoặc sóng 4 (hoặc bán ngược lại
    trong xu hướng giảm).

3. H4

Tìm các tín hiệu SMC: - Liquidity Sweep - CHoCH - BOS - Order Block -
FVG - Chờ giá retest Order Block để vào lệnh.

4. Volume Profile

Kiểm tra: - POC trùng Order Block. - HVN gần vùng vào lệnh. - Tránh vào
lệnh nếu chỉ có LVN.

Điều kiện vào lệnh

1.  Weekly cùng xu hướng.
2.  Elliott ở cuối sóng điều chỉnh.
3.  Có Liquidity Sweep.
4.  Có CHoCH.
5.  Có BOS.
6.  Retest Order Block.
7.  FVG còn hiệu lực.
8.  POC/HVN xác nhận.
9.  Risk:Reward tối thiểu 1:3.

Quản lý lệnh

-   Stop Loss: dưới đáy Sweep (Buy) hoặc trên đỉnh Sweep (Sell).
-   Take Profit:
    -   Mục tiêu sóng 3 hoặc sóng 5.
    -   Hoặc Fibonacci Extension 1.272 / 1.618.
-   Dời Stop Loss về hòa vốn khi đạt RR 1:1.

Lưu ý

-   Không giao dịch ngược xu hướng Weekly.
-   Không vào lệnh chỉ vì có Order Block.
-   Chỉ giao dịch khi có nhiều yếu tố đồng thuận (confluence).
